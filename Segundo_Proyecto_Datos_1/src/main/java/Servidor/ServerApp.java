...
class ClientHandler extends Thread{
        ...
        try {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    arbolBinario.insertarNodo(nodo);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean verificarExistencia(String user,String password){

        ArbolBinario arbolBinario = obtenerListaAdministradores();

        boolean resultado = arbolBinario.buscarPersona(user, password);
        ...
        while (true){
            ...
            try {
                ...
                if (message.getNombreMetodo().equals("LoginAdmin")){
                    ...
                    boolean existe = verificarExistencia(usuario,contra);
                    ...
                    if (message.getUsuario().equals("Pedro")){
                        if (message.getPassword().equals("123")){
                            System.out.println("Se intenta responder al client");
